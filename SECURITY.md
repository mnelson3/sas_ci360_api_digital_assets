...
This repository holds a retained historical/archived reference implementation of a Python client for the SAS Customer Intelligence 360 Digital Assets API (digital assets, folders, renditions, and revisions). It has been superseded by `sas-ci360-sol-content-delivery` and is no longer actively developed. Only the code currently deployed on each environment branch is supported — there is no long-term support for older commits.
...
- GitHub's [private vulnerability reporting](https://github.com/mnelson3/sas_ci360_api_digital_assets-archived/security/advisories/new) (enabled on this repo), or
